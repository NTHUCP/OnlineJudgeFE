export const m = {
  ...
  Close: '關閉',
  View_Contest: '查看比賽',
  Are_you_sure_you_want_to_reset_your_code: '你確定要清除你的程式碼嗎?',
  Code_can_not_be_empty: '你不能送出空的程式碼',
  Submit_code_successfully: '成功送出程式碼',
  You_have_solved_the_problem: '你已經解過了這題',
  Submitted_successfully: '成功送出',
  You_have_submitted_a_solution: '你已經送出了解答.',
  Contest_has_ended: '比賽已經結束',
  You_have_submission_in_this_problem_sure_to_cover_it: '你已經送出了解答，確定要覆蓋嗎?',
  // About.vue
  Compiler: '編譯器',
